						        ...
						        <div id="mediaceb" class="tab">
						        	<div class="row">
										...
										<div class="title-hd-sm">
                                                                                    <a href="#"><h4>Photos <span></span></h4></a>
										</div>
										<?php
                        $mid=$_GET['mid'];
						        	...
						        	<div class="row">
										...
										<div class="mvcast-item">
                                                                                    <?php
                        $mid=$_GET['mid'];
                                                        $ct=mysqli_query($dbcon,"select * from as_cast where cid='$mid'");
                                                       while($ct1=mysqli_fetch_row($ct))
                                                            {
                                                           
                                                       $mov=  mysqli_query($dbcon,"select * from movie where id='$ct1[1]'");
                          $mov1=  mysqli_fetch_row($mov);
                                                        ?>
