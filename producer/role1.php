                    ...
                    if(isset($_POST['sub1']))
 {
   ...
   $t2=$_POST['t2'];
    ...
    $date=date('Y-m-d');
      ...
      $ins1=mysqli_query($dbcon,"insert into role values('','$t1','$t2','$t3','$usr','Producer','$date','0')");
        if($ins1>0)
        {
                            ...
                            <h3>All Report</h3>
                                    ...
                                    <tbody>
                                         <?php
                                                            ...
                                                            {
                                                                $an=mysqli_query($dbcon,"select * from reg1 where em='$r_gal[4]'");
