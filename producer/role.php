...
<div class="page-single">
	<div class="container">
		<div class="row ipad-width2">
			...
			<div class="col-md-12 col-sm-12 col-xs-12">
                           ...
                           $sel_gal=mysqli_query($dbcon,"select * from role where uid='$usr'  order by id desc");
                                    ...
                                    <thead>
                                        ...
                                        <tr>
                                            ...
                                            <th style="color: white" scope="col">From</th>
                                            <th style="color: white" scope="col">Assignation</th>
                                            <th style="color: white" scope="col">Date</th>
                                            <th style="color: white" scope="col">More</th>
                                        </tr>
    ...
    $an1=mysqli_fetch_row($an);
                                                                ...
                                                                ?>
                                        <tr>
                                            <th style="color: white" scope="row"><?php echo $i ?></th>
                                            
                                            <td style="color: white"><?php echo $r_gal[1] ?></td>
                                             <td style="color: white"><?php echo $r_gal[2] ?></td>
                                             <td style="color: white"><?php echo $r_gal[3] ?></td>
                                             <td style="color: white"><?php echo $an1[1] ?></td>
                                             <td style="color: white"><?php echo $r_gal[5] ?></td>
                                              <td style="color: white"><?php echo $r_gal[6] ?></td>
                                             <td><a target="_blank" href="../img5/<?php echo $r_gal[3] ?>"><span style="color: green" class="fa fa-download"></span></a></td>
