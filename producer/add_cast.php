                    ...
                    if(isset($_POST['sub1']))
 {
   ...
   $t2=$_POST['t2'];
    ...
    $sel=  mysqli_query($dbcon,"select * from cast where nme='$t1'");
      ...
      $ins1=mysqli_query($dbcon,"insert into as_cast values('','$mid','$t1','$r[0]','$t2','0')");
        if($ins1>0)
        {
                header("location:add_cast.php?mid=$mid");
            }
    }
			...
			<div class="col-md-9 col-sm-12 col-xs-12">
				<div class="form-style-1 user-pro" action="#">
						...
						<h4>Add Cast</h4>
								...
								<label>Actor</label>
								<input type="text" required=""required="" name="t1" id="stn" placeholder="Select Actor" class="form-control"autocomplete="off"  onkeyup="loadstop(this.value)" />	
                                                <br/>
                                                                <div id="stp"></div>
                                                <script>
                                                function loadstop(x){
							...
							<div class="col-md-12 form-it">
								...
								<input type="text" required=""required=""name="t2" placeholder="edwardkennedy">
							</div>
                          ...
                          $r_cast=  mysqli_fetch_row($sel_cast);
													...
													<div class="cast-left">
                                                                                                            <img style="width: 35px;height: 35px" src="../img1/<?php echo $r_cast[10] ?>" alt="">
                                                                                                                <a style="color: lightskyblue " href=""><?php echo $cast1[2] ?>.</a>
                                                                                                                 <span style="float: right;color: whitesmoke">...  <?php echo $cast1[4] ?></span>
													</div>
