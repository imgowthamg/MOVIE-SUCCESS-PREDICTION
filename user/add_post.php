...
$msg2=  nl2br($msg1);
   ...
   $up=$_FILES['myFile']['name'];
    ...
    $nfn=$count."".substr($up,strrpos($up,"."));
     ...
     if(move_uploaded_file($_FILES['myFile']['tmp_name'],getcwd()."//../img9//$nfn"))
    {
    ...
    $nfn1=$count1."".substr($up1,strrpos($up1,"."));
     ...
     if(move_uploaded_file($_FILES['myFile1']['tmp_name'],getcwd()."//../img10//$nfn1"))
    {
          
    
   
      $ins1=mysqli_query($dbcon,"insert into u_post values('','$t1','$msg2','$nfn','$nfn1','$date','$usr','0')");
        if($ins1>0)
        {
			...
			<div class="col-md-12 col-sm-12 col-xs-12">
				<div class="form-style-1 user-pro" action="#">
						...
						<div class="row">
							...
							<div class="col-md-12 form-it">
								<label>Video</label>
								<input name="myFile1"accept="video/*" type="file" class="form-control" >
							</div>
						</div>
