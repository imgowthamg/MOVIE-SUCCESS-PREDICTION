...
<?php
                    ...
                    if(isset($_POST['sub1']))
 {
require_once __DIR__ . '/ok/autoload.php';
...
$msg2=  nl2br($msg1);                     
      ...
      $ins1=mysqli_query($dbcon,"insert into review values('','$mid','$string','$msg2','$usr','$date','$val')");
        if($ins1>0)
        {
                header("location:mov_dt.php?mid=$mid#reviews");
            }
    }
...
<script src="https://canvasjs.com/assets/script/canvasjs.min.js"></script>
					...
					<div class="movie-tabs">
						            ...
						            <div class="row">
						            	<div class="col-md-8 col-sm-12 col-xs-12">
						            		...
						            		<div class="title-hd-sm">
												<h4>Photos</h4>
												<a href="#" class="time">Movie Images <i class="ion-ios-arrow-right"></i></a>
											</div>
                        ...
                        $mid=$_GET['mid'];
											...
											<div class="title-hd-sm">
												<h4>cast</h4>
												<a href="#" class="time">Cast & Crew  <i class="ion-ios-arrow-right"></i></a>
											</div>
											<!-- movie cast -->
                          ...
                          $r_cast=  mysqli_fetch_row($sel_cast);
											...
											<div class="title-hd-sm">
												<h4>User reviews</h4>
												<a href="#" class="time">Reviews <i class="ion-ios-arrow-right"></i></a>
											</div>
											<!-- movie user review -->
						        ...
						        <div id="reviews" class="tab review">
						           <div class="row">
						            	<div class="rv-hd">
							            	...
							            	<a  href="#"  data-toggle="modal" data-target="#basicModal"class="redbtn">Write Review</a>
  ...
  <div class="form-style-1 user-pro" action="#">
						...
						<div class="row">
							<div class="col-md-12 form-it">
								<label>Title</label>
								<input type="text" required=""name="t1" placeholder="">
							</div>
							...
							<div class="col-md-12 form-it">
								<label>Review</label>
                                                                <textarea name="t2" cols="6" rows="6" placeholder="" class="form-control"style="background-color: #1c3d5d;border-color: #1c3d5d"></textarea>
							</div>
