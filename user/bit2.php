		...
		<div class="row ipad-width2">
			<div class="col-md-8 col-sm-12 col-xs-12">
				...
				<?php
                                                        ...
                                                        $sel_gal1=mysqli_query($dbcon,"select * from a_bit order by id desc ");
                                                       while($r_gal1=mysqli_fetch_row($sel_gal1))
                                                       {
                                                        $sel_gal=mysqli_query($dbcon,"select * from movie where id='$r_gal1[2]'");
				...
				<div class="movie-item-style-2">
						...
						<div class="mv-item-infor">
                                                    ...
                                                    <p style="color: white;font-size: x-large" class="describe"><?php echo $r_gal1[1] ?> <a target="_blank" href="result.php?aid=<?php echo $r_gal1[0] ?>&mid=<?php echo $r_gal[0] ?>"><span style="color: green" class="fa fa-trophy"></span></a></p>
