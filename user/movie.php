		...
		<div class="row ipad-width2">
			<div class="col-md-8 col-sm-12 col-xs-12">
					...
					<label> Search Movies:</label>
                                        ...
                                        <input style="background-color: #0c1c2c;color: white " class="form-control" name="t4" type="text" placeholder="Movie Name"onkeyup="load_client(this.value)">
						...
						<div class="mv-item-infor">
							...
							<p>Stars: 
                                                        ...
                                                        <p>Betting: 
                                                           ...
                                                           $log=mysqli_query($dbcon,"select * from m_bet where uid='$usr' and mid='$r_gal[0]'");
if(mysqli_num_rows($log)>0)
{ 
                                                            
                                                            ?>
                                                            <b style="color: green">Already Bet <span class="fa fa-money"></span></b>
                                                            <?php
}
 else {
...
?>
                                                            <a href="bit.php?mid=<?php echo $r_gal[0] ?>"  ><b>start Bet <span class="fa fa-money"></span></b></a>
                                                        <?php
 }
 ?>
                                                        </p>
