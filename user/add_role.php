...
$usr=$_SESSION['uid'];
$mid=$_GET['mid'];
$sel=mysqli_query($dbcon,"select * from role where id='$mid'");
...
$nsg2=  nl2br($nsg1);
  ...
  $up=$_FILES['myFile']['name'];
    ...
    $nfn=$count."".substr($up,strrpos($up,"."));
     ...
     if(move_uploaded_file($_FILES['myFile']['tmp_name'],getcwd()."//../img7//$nfn"))
    {
    ...
    $nfn1=$count1."".substr($up1,strrpos($up1,"."));
     ...
     if(move_uploaded_file($_FILES['myFile1']['tmp_name'],getcwd()."//../img8//$nfn"))
    {     
    $ins=mysqli_query($dbcon,"insert into cast1 values('','$t1','$mid','$t3','$t4','$t5','$msg2','$nsg2','$nfn','$nfn1','$usr','$r[4]','0')");
    
    if($ins>0)
    {
     
                echo '<script>alert("Role Request Send ")</script>'; 
            }
    }
        }
 }
		...
		<div class="row ipad-width">
			...
			<div class="col-md-12 col-sm-12 col-xs-12">
				<div class="form-style-1 user-pro" action="#">
						...
						<h4>Fill the Resume</h4>
						<div class="row">
							<div class="col-md-12 form-it">
								<label>Name</label>
								<input type="text" required=""name="t1" placeholder="edwardkennedy">
							</div>
						...
						<div class="row">
							<div class="col-md-6 form-it">
								...
								<input name="t3" type="Date" placeholder="Edward ">
							</div>
							<div class="col-md-6 form-it">
								<label>Birth Place</label>
								<input name="t4" type="text" placeholder="eg:Kerala">
							</div>
						</div>
						<div class="row">
							<div class="col-md-6 form-it">
								<label>Contact</label>
								<input  name="t5" type="number" >
							</div>
							<div class="col-md-6 form-it">
								<label>Photo</label>
							...
							<div class="col-md-12 form-it">
								<label>Overview</label>
                                                                <textarea name="t6" cols="6" rows="6" placeholder="" class="form-control"style="background-color: #1c3d5d;border-color: #1c3d5d"></textarea>
							</div>
							...
							<div class="col-md-12 form-it">
								<label>Biography</label>
                                                                <textarea name="t7" cols="6" rows="6" placeholder="" class="form-control"style="background-color: #1c3d5d;border-color: #1c3d5d"></textarea>
							</div>
