                    ...
                    if(isset($_POST['sub1']))
 {
   ...
   $t2=$_POST['t2'];
    ...
    $t4=$_POST['t4'];
      ...
      $ins1=mysqli_query($dbcon,"insert into m_bet values('','$t1','$mid','$usr','0')");
        if($ins1>0)
        {
             $ins1=mysqli_query($dbcon,"insert into m_bet values('','$t2','$mid','$usr','0')");
        if($ins1>0)
        {
             $ins1=mysqli_query($dbcon,"insert into m_bet values('','$t3','$mid','$usr','0')");
        if($ins1>0)
        {
         $ins1=mysqli_query($dbcon,"insert into m_bet values('','$t4','$mid','$usr','0')");
        if($ins1>0)
        {
				...
				<div class="form-style-1 user-pro" action="#">
						...
						<div class="row">
							<div class="col-md-12 form-it">
								<label>Will the movie will be a hit?</label>
								<select name="t1">
								  <option value="">--Select One--</option>
								  <option value="Movie Is a Hit">YES</option>
                                                ...
                                                <div class="row">
							<div class="col-md-12 form-it">
								<label>Will the movie get any award?</label>
								<select name="t2">
								  <option value="">--Select One--</option>
								  <option value="Best Movie">YES</option>
                                                                   <option value="No">NO</option>
                                                ...
                                                <div class="row">
							<div class="col-md-12 form-it">
								<label>Will the actors in the movie get any award?</label>
								<select name="t3">
								  <option value="">--Select One--</option>
								  <option value="Best Actor">YES</option>
                                                                   <option value="No">NO</option>
                                                ...
                                                <div class="row">
							<div class="col-md-12 form-it">
								<label>Will the actress in the movie get any award?</label>
								<select name="t4">
								  <option value="">--Select One--</option>
								  <option value="Best Actress">YES</option>
                                                                   <option value="No">NO</option>
