...
<?php
                    ...
                    if(isset($_POST['sub1']))
 {
   ...
   $sel1=  mysqli_query($dbcon,"select * from movie where nme='$t1'");
                          $r1=  mysqli_fetch_row($sel1);
   
      $ins1=mysqli_query($dbcon,"insert into aw_movie values('','$t2','$t1','$r1[0]','$usr','0')");
        if($ins1>0)
        {
                header("location:aw_movie.php");
            }
    }
			...
			<div class="col-md-9 col-sm-12 col-xs-12">
				<div class="form-style-1 user-pro" action="#">
						...
						<h4>Assign MOvie  Award</h4>
								...
								<label>Movie </label>
								<input type="text" required=""required="" name="t1" id="stn1" placeholder="Select Movie" class="form-control"autocomplete="off"  onkeyup="loadstop1(this.value)" />	
                                                <br/>
                                                                <div id="stp1"></div>
                                                <script>
							...
							<div class="col-md-12 form-it">
								<label>Award</label>
								<input type="text" required=""required=""name="t2" placeholder="Award Name">
							</div>
