		...
		<div class="row ipad-width2">
			<div class="col-md-8 col-sm-12 col-xs-12">
				...
				<?php
                                                        ...
                                                        $sel_gal1=mysqli_query($dbcon,"select * from screen where tid='$usr'");
                                                       while($r_gal1=mysqli_fetch_row($sel_gal1))
                                                       {
                                                           $sel_gal2=mysqli_query($dbcon,"select * from as_movie where screen='$r_gal1[0]' order by id desc limit 1");
                                                     $r_gal2=mysqli_fetch_row($sel_gal2);
                                                     
                                                     
                                                        $sel_gal=mysqli_query($dbcon,"select * from movie where id='$r_gal2[1]'");
				...
				<div class="movie-item-style-2">
						...
						<div class="mv-item-infor">
                                                    ...
                                                    <p style="color: white;font-size: x-large" class="describe"><?php echo $r_gal1[1] ?>
                                                    
                                                    <br/><br/>
                                                    <span style="font-size: small">
                                                        <?php
                                                         $sel_gal3=mysqli_query($dbcon,"select * from tm where sid='$r_gal2[0]'");
                                                       while($r_gal3=mysqli_fetch_row($sel_gal3))
                                                       {
                                                        
                                                        
                                                        ?>
                                                         <span style="border: #06121e solid 1px;border-color:white;padding: 7px"><?php echo $r_gal3[2] ?> </span>&nbsp;&nbsp;
