...
<?php
                    ...
                    if(isset($_POST['sub1']))
 {
    ...
    $t1=$_POST['t1'];
      ...
      $ins1=mysqli_query($dbcon,"insert into tm values('','$mid','$t1','0')");
        if($ins1>0)
        {
                header("location:tm.php?mid=$mid");
            }
    }
...
{
                                $mid=$_GET['mid'];
    $del1=mysqli_query($dbcon,"delete from tm where id='".$_GET['del']."'");
    //echo mysql_error();
    if($del1>0)
    {
       header("location:tm.php?mid=$mid");
...
<div class="page-single">
	<div class="container">
		...
		<div class="col-md-3 col-sm-12 col-xs-12">
            ...
            $sel_p=mysqli_query($dbcon,"select * from tm where sid='$mid' ");
            ...
            <tr>
                 ...
                 <td style="color: white">Showtime</td>
            ...
            <tr>
                ...
                <td style="color: white">#</td>
                 <td style="color: white"><?php echo $r_p[2] ?></td>
                 <td><a href="tm.php?del=<?php echo $r_p[0] ?>&mid=<?php echo $mid ?>"><span style="color: red" class="fa fa-trash"></span></a></td>
            </tr>
            <?php
            }
            ?>
