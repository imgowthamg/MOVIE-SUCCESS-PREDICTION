...
<?php
                    ...
                    if(isset($_POST['sub1']))
 {
   ...
   $sel1=  mysqli_query($dbcon,"select * from movie where nme='$t1'");
      ...
      $ins1=mysqli_query($dbcon,"insert into as_movie values('','$r1[0]','$t1','$t2','$usr','0')");
      $bid = mysqli_insert_id($dbcon);
        if($ins1>0)
        {
                header("location:tm.php?mid=$bid");
            }
    }
						...
						<h4>Assign Movie</h4>
							...
							<div class="col-md-12 form-it">
								<label>Screen</label>
                                        ...
                                        <?php
                                        $sel_state=mysqli_query($dbcon,"select * from screen where tid='$usr'");
