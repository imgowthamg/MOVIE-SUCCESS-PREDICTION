	...
	<div class="container">
		<div class="row ipad-width2">
                    <?php
                                                        ...
                                                        $sel_gal=mysqli_query($dbcon,"select * from cast where pro='2'");
							...
							<div class="ceb-infor">
                                            ...
                                            if($r_gal[2]=="1")
                                            {
                                                ?>
                                                            ...
                                                            <h2><a href="cast_dt1.php?mid=<?php echo $r_gal[0] ?>"><?php echo $r_gal[1] ?></a></h2>
                                            <?php
                                            ...
                                            {
                                            ?>
                                                             <h2><a href="cast_dt2a.php?mid=<?php echo $r_gal[0] ?>"><?php echo $r_gal[1] ?></a></h2>
