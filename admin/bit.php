		...
		<div class="row ipad-width">
			...
			<div class="col-md-6 col-sm-6 col-xs-6">
				<div class="form-style-1 user-pro" action="#">
						...
						<h4>MOVIE RESULT & AWARD</h4>
						<div class="row">
							<div class="col-md-12 form-it">
								<label>Result</label>
								<select name="t1">
								  <option value="">--Select One--</option>
								  <option value="Movie Is a Hit">Movie Is a Hit</option>
                                                                   <option value="Best Movie">Best Movie</option>
            ...
            $sel_p=mysqli_query($dbcon,"select * from a_bit where mid='$mid'");
            ...
            <tr>
                ...
                <td style="color: white"><?php echo $i ?></td>
                 ...
                 <td><a target="_blank" href="result.php?aid=<?php echo $r_p[0] ?>&mid=<?php echo $mid ?>"><span style="color: green" class="fa fa-trophy"></span></a> &nbsp;&nbsp;<a href="bit.php?del=<?php echo $r_p[0] ?> &mid=<?php echo $mid ?>"><span style="color: red" class="fa fa-trash"></span></a></td>
            </tr>
            <?php
            }
            ?>
