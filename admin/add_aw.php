...
<?php
                    ...
                    if(isset($_POST['sub1']))
 {
   ...
   $t2=$_POST['t2'];
    ...
    $ins=mysqli_query($dbcon,"insert into award_ad values('','$t1','$t2','$t3','$t4','$t5','0')");
    
    if($ins>0)
    {
      $ins1=mysqli_query($dbcon,"insert into user_log values('','$t4','$t5','award','0')");
        if($ins1>0)
        {
                header("location:add_aw.php?suss=1");
            }
    }
        }
		...
		<div class="col-md-3 col-sm-12 col-xs-12">
			...
			<div class="col-md-9 col-sm-12 col-xs-12">
				<div class="form-style-1 user-pro" action="#">
						...
						<h4>Add award committee</h4>
						<div class="row">
							<div class="col-md-12 form-it">
								<label>Committee Name</label>
								<input type="text" required=""name="t1" placeholder="$#@ Award Committe">
							</div>
						...
						<div class="row">
							<div class="col-md-12 form-it">
								...
								<input type="text" required=""name="t2" placeholder="edwardkennedy">
							</div>
							...
							<div class="col-md-12 form-it">
								<label>Contact</label>
								<input type="text" required=""name="t3" placeholder="Contact Info">
							</div>
							...
							<div class="col-md-6 form-it">
								<label>Email</label>
								<input type="text" required=""name="t4" placeholder="$%$@gmail.com ">
							</div>
							<div class="col-md-6 form-it">
								<label>Password</label>
								<input type="password" name="t5" placeholder="*********">
							</div>
						</div>
						<div class="row">
							<div class="col-md-2">
