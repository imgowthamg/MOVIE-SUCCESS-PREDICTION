...
$nsg2=  nl2br($nsg1);
  ...
  $up=$_FILES['myFile']['name'];
    ...
    $ins=mysqli_query($dbcon,"insert into cast values('','$t1','$t2','$t3','$t4','$t5','$msg2','$nsg2','$t8','$t9','$nfn','0')");
    
    if($ins>0)
    {
      $ins1=mysqli_query($dbcon,"insert into user_log values('','$t8','$t9','$t2','0')");
        if($ins1>0)
        {
                header("location:add_dir.php?suss=1");
            }
    }
        }
 }
		...
		<div class="col-md-3 col-sm-12 col-xs-12">
			...
			<div class="col-md-9 col-sm-12 col-xs-12">
				<div class="form-style-1 user-pro" action="#">
						...
						<div class="row">
							<div class="col-md-6 form-it">
								<label>First Apperance</label>
								<input  name="t5" type="Date" placeholder="Edward ">
							</div>
							<div class="col-md-6 form-it">
								<label>Photo</label>
							...
							<div class="col-md-6 form-it">
								<label>Email</label>
								<input type="text" required=""name="t8" placeholder="$%$@gmail.com ">
							</div>
							<div class="col-md-6 form-it">
								<label>Password</label>
								<input type="password" name="t9" placeholder="*********">
							</div>
						</div>
						<div class="row">
							<div class="col-md-2">
