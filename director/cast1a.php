	...
	<div class="container">
		<div class="row ipad-width2">
                    <?php
                                                        ...
                                                        $sel_gal=mysqli_query($dbcon,"select * from cast1 where sid='$usr' order by id desc");
			...
			<div class="col-md-9 col-sm-12 col-xs-12">
				...
				<div class="row">
                                     ...
                                     <?php
                                                            ...
                                                            {
                                                                $an=mysqli_query($dbcon,"select * from role where id='$r_gal[2]'");
    $an1=mysqli_fetch_row($an);
    
    $bn=mysqli_query($dbcon,"select * from cast where em='$an1[4]'");
    $bn1=mysqli_fetch_row($bn);
                                                                $i++;
                                                                ?>
					<div class="col-md-12">
						<div class="ceb-item-style-2">
                                                    <img style="width: 200px;height: 200px" src="../img7/<?php echo $r_gal[8] ?>" alt="">
							<div class="ceb-infor">
                                                            <h2><a href="cast_dt1a.php?mid=<?php echo $r_gal[0] ?>"><?php echo $r_gal[1] ?></a></h2>
								
								<p><?php echo $an1[5] ?>: <a href="#"><?php echo $bn1[1] ?></a></p>
                                                                <p><b style="color: white"><?php echo $an1[1] ?></b></p>
                                                                <p><?php echo substr($r_gal[6],0,200)?>.....</p>
							</div>
						</div>
					</div>
					<?php
