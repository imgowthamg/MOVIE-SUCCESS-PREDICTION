...
<?php
$mid=$_GET['mid'];
$sel1=  mysqli_query($dbcon,"select * from cast1 where id='$mid'");
	...
	<div class="container">
		<div class="row ipad-width">
			<div class="col-md-4 col-sm-12 col-xs-12">
				<div class="mv-ceb">
                                    <img style="width: 100%;height: 350px" src="../temp/../img7/<?php echo $r1[8] ?>" alt="">
				</div>
			</div>
						        ...
						        <div id="overviewceb" class="tab active">
						            <div class="row">
						            	...
						            	<div class="col-md-4 col-xs-12 col-sm-12">
						            		...
						            		<div class="sb-it">
						            			<h6>Contact:</h6>
                                                                                <p><a href="tel:<?php echo $r1[5] ?>"><?php echo $r1[5] ?> <span class="fa fa-phone"></span></a></p>
						            		</div>
						        ...
						        <div id="mediaceb" class="tab">
						        	<div class="row">
										...
										<div class="title-hd-sm">
                                                                                    <a href="#"><h4>Video <span></span></h4></a>
										</div>
                                                                    <video width="100%"controls onclick="load_vdo('<?php echo $r1[9] ?>')" autoplay="autoplay"><source src="../img8/<?php echo $r1[9] ?>" type="video/mp4">
                                                <source src="../img8/<?php echo $r1[9] ?>" type="video/ogg"></video>
