                    ...
                    if(isset($_POST['sub1']))
 {
   ...
   $t2=$_POST['t2'];
    ...
    $date=date('Y-m-d');
      ...
      $ins1=mysqli_query($dbcon,"insert into role values('','$t1','$t2','$t3','$usr','Director','$date','0')");
        if($ins1>0)
        {
				...
				<div class="form-style-1 user-pro" action="#">
						...
						<div class="row">
							...
							<div class="col-md-12 form-it">
								<label>Gender</label>
                                                                <br/>
								<input type="radio" value="Male"name="t2" >Male <input type="radio" value="Female"name="t2" >Female
							</div>
							...
							<div class="col-md-12 form-it">
								<label>Role Description</label>
                                                                <textarea name="t3" cols="6" rows="6" placeholder="" class="form-control"style="background-color: #1c3d5d;border-color: #1c3d5d"></textarea>
							</div>
