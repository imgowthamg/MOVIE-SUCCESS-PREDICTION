	...
	<div class="container">
		<div class="row ipad-width2">
                    <?php
                                                        ...
                                                        $sel_gal1=mysqli_query($dbcon,"select * from aw_cast");
			...
			<div class="col-md-9 col-sm-12 col-xs-12">
				...
				<div class="row">
                                     ...
                                     <?php
                                                            ...
                                                            {
                                                                 $sel_gal=mysqli_query($dbcon,"select * from cast where id='$r_gal1[2]'");
                                                                 $r_gal=mysqli_fetch_row($sel_gal);
                                                                  $sel=mysqli_query($dbcon,"select * from award_ad where em='$r_gal1[7]'");
                                                                 $r=mysqli_fetch_row($sel);
                                                                
                                                                ?>
					<div class="col-md-12">
						<div class="ceb-item-style-2">
                                                    <img style="width: 320px;height: 230px" src="../img1/<?php echo $r_gal[10] ?>" alt="">
							<div class="ceb-infor">
                                            ...
                                            {
                                            ?>
                                                             <h2><a href="cast_dt2.php?mid=<?php echo $r_gal[0] ?>"><?php echo $r_gal[1] ?></a></h2>
                                            ...
                                            ?>
                                                            ...
                                                            <br/>
                                                              <br/>
                                                            <span>
                                                                 <h6><?php echo $r[1] ?> <span class=""></span></h6>
                                                                 <br/>
                                                                 <h3 style="color: white"><?php echo $r_gal1[3] ?></h3>
